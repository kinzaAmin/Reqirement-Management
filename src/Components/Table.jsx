...
const Table = (props) => {
  const recruitmentData = [
    ...
    },
    {
      ...
      name: "Faiza Aslam",
      Candidate_Number: "3",
      start_date: "25/jun/2022",
    },
    {
      id: "RID-004",
      name: "Zubia Alam",
      Candidate_Number: "4",
      start_date: "22/jun/2022",
    },
    {
      id: "RID-005",
      name: "Sadaf Amin",
      Candidate_Number: "5",
      start_date: "24/july/2022",
    },
    {
      id: "RID-006",
      name: "Alizay Amin",
      Candidate_Number: "6",
      start_date: "24/April/2022",
    },
  ];
  const [itemRemove, setItemRemove] = useState(recruitmentData);
  const [displayedAarrayy, setIDisplayed] = useState(recruitmentData);
  const removeItem = (id) => {
    setItemRemove(itemRemove?.filter((item) => item.Candidate_Number !== id));
    setIDisplayed(itemRemove);
  };
  ...
  return (
    <div className="tableContainer">
      ...
      {displayedAarrayy?.map((data, index) => (
        <div key={index} className="table-data">
          ...
          <div className="actions">
            ...
            <img
              alt=""
              src={dell}
              onClick={() => removeItem(data.Candidate_Number)}
            />
            <img alt="" src={edit} />
            <img alt="" src={addnew} />
          </div>
